...
export class DatabaseStorage implements IStorage {
  ...
  async getLlmConfig(): Promise<LlmConfig> {
    ...
    return {
      ...
      deepReachEnabled: configMap.deepReachEnabled === undefined ? false : configMap.deepReachEnabled === "true",
      deepReachEndpoint: configMap.deepReachEndpoint,
